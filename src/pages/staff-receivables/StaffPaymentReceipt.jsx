...
export function StaffPaymentReceipt() {
  ...
  const canEdit = !isEmployee && employee
    ...
    <div className="max-w-3xl mx-auto print-area" style={{ '--invoice-accent': accent }}>
      <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mb-6 print-hide">
        ...
        <div className="flex flex-wrap gap-2 w-full sm:w-auto">
          {canEdit && (
            <Link to={`/staff-receivables/${employee.id}/collect?edit=${payment.id}`} className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-4 py-2 bg-zinc-800 border border-zinc-700 text-zinc-200 rounded-md hover:bg-zinc-700">
